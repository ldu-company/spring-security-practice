package com.practice.spring.security.note;

import com.practice.spring.security.entity.Note;
import com.practice.spring.security.entity.User;
import com.practice.spring.security.repository.NoteRepository;
...
//    }
     ...
     * value: userDetailsService를 통해 가져올 수 있는 유저
     * userDetailsServiceBeanName : UserDetailsService 구현체의 Bean
     * setupBefore : 테스트 실행 직전에 유저를 가져온다.
     *
     * setUp 에서 생성한 유저를 찾아 온다.
     */
    @Test
    @WithUserDetails(
            value = "user123",
